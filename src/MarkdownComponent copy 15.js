    ...
    code({ node, inline, className, children, ...props }) {
      ...
      if (!inline && match) {
        ...
        const handleClick = () => {
          ...
          setTimeout(() => setCopyMessages((prevMessages) => ({ ...prevMessages, [codeString]: null })), 2000);
        };
        ...
        return (
          <div className="code-block">
            ...
            {copyMessages[codeString] && <div className="copy-message">{copyMessages[codeString]}</div>}
          </div>
        );
      }
